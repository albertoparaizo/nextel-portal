...
import br.com.nextel.architecture.model.valueobject.GetOpenTitlesV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetOpenTitlesV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				GetOpenTitlesV1VO getOpenTitlesV1VO = new GetOpenTitlesV1VO();
				getOpenTitlesV1VO.setAPI_NAME("/GetOpenTitles/V1");
				getOpenTitlesV1VO.setAccess_token(access_token);
				getOpenTitlesV1VO.setClientId("URAVOICE");
				getOpenTitlesV1VO.setDocumentNumber("59104273000129");
				getOpenTitlesV1VO = (GetOpenTitlesV1VO) http.sendPost(getOpenTitlesV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getOpenTitlesV1VO.getResponseJsonByStringReader());
