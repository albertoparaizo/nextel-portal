...
import br.com.nextel.architecture.model.valueobject.GetCustomerSegmentV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetCustomerSegmentV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetCustomerSegment/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetCustomerSegmentV1VO getCustomerSegmentV1VO = new GetCustomerSegmentV1VO();
				getCustomerSegmentV1VO.setAPI_NAME("/GetCustomerSegment/V1");
				getCustomerSegmentV1VO.setAccess_token(access_token);
				getCustomerSegmentV1VO.setClientId("URAVOICE");
				getCustomerSegmentV1VO.setDocumentNumber("59104273000129");
				getCustomerSegmentV1VO = (GetCustomerSegmentV1VO) http.sendPost(getCustomerSegmentV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getCustomerSegmentV1VO.getResponseJsonByStringReader());
