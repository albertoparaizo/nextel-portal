...
import br.com.nextel.architecture.model.valueobject.GetDaysSinceLastCustomerActivationV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetDaysSinceLastCustomerActivationV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetDaysSinceLastCustomerActivation/V1/oauth2/token:::::::::::::::::*/
				...
				oauth2vo.setAPI_NAME("/GetDaysSinceLastCustomerActivation/V1/oauth2/token");
				...
				/**:::::::::::::::::GetDaysSinceLastCustomerActivation/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetDaysSinceLastCustomerActivationV1VO getDaysSinceLastCustomerActivationV1VO = new GetDaysSinceLastCustomerActivationV1VO();
				getDaysSinceLastCustomerActivationV1VO.setAPI_NAME("/GetDaysSinceLastCustomerActivation/V1");
				getDaysSinceLastCustomerActivationV1VO.setAccess_token(access_token);
				getDaysSinceLastCustomerActivationV1VO.setClientId("URAVOICE");
				getDaysSinceLastCustomerActivationV1VO.setPhoneNumber("5511947107466");
				getDaysSinceLastCustomerActivationV1VO = (GetDaysSinceLastCustomerActivationV1VO) http.sendPost(getDaysSinceLastCustomerActivationV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getDaysSinceLastCustomerActivationV1VO.getResponseJsonByStringReader());
