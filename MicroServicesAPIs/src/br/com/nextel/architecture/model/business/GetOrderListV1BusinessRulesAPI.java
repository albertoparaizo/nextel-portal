...
import br.com.nextel.architecture.model.valueobject.GetOrderListV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetOrderListV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				oauth2vo.setAPI_NAME("/GetOrderList/V1/oauth2/token");
				...
				GetOrderListV1VO getOrderListV1VO = new GetOrderListV1VO();
				getOrderListV1VO.setAPI_NAME("/GetOrderList/V1");
				getOrderListV1VO.setAccess_token(access_token);
				getOrderListV1VO.setClientId("URAVOICE");
				getOrderListV1VO.setDocumentNumber("59104273000129");
				getOrderListV1VO = (GetOrderListV1VO) http.sendPost(getOrderListV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getOrderListV1VO.getResponseJsonByStringReader());
