...
import br.com.nextel.architecture.model.valueobject.GetContractTicklerV1VO;
...
public class GetContractTicklerV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetContractTickler/V1/oauth2/token:::::::::::::::::*/
				...
				oauth2vo.setAPI_NAME("/GetContractTickler/V1/oauth2/token");
				...
				/**:::::::::::::::::GetContractTickler/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetContractTicklerV1VO getContractTicklerV1VO = new GetContractTicklerV1VO();
				getContractTicklerV1VO.setAPI_NAME("/GetContractTickler/V1");
				getContractTicklerV1VO.setAccess_token(access_token);
				getContractTicklerV1VO.setClientId("URAVOICE");
				getContractTicklerV1VO.setContractId("11795890");
				getContractTicklerV1VO = (GetContractTicklerV1VO) http.sendPost(getContractTicklerV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getContractTicklerV1VO.getResponseJsonByStringReader());
