...
import br.com.nextel.architecture.model.valueobject.GetSaleResponsibleV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetSaleResponsibleV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetSaleResponsible/V1/oauth2/token:::::::::::::::::*/
				...
				oauth2vo.setAPI_NAME("/GetSaleResponsible/V1/oauth2/token");
				...
				/**:::::::::::::::::GetSaleResponsible/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetSaleResponsibleV1VO getSaleResponsibleV1VO = new GetSaleResponsibleV1VO();
				getSaleResponsibleV1VO.setAPI_NAME("/GetSaleResponsible/V1");
				getSaleResponsibleV1VO.setAccess_token(access_token);
				getSaleResponsibleV1VO.setClientId("URAVOICE");
				getSaleResponsibleV1VO.setOrderNumber("1438504517");
				getSaleResponsibleV1VO = (GetSaleResponsibleV1VO) http.sendPost(getSaleResponsibleV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getSaleResponsibleV1VO.getResponseJsonByStringReader());
