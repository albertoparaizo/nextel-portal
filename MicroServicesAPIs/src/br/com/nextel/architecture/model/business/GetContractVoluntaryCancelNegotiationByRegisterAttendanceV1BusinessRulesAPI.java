...
import br.com.nextel.architecture.model.valueobject.GetContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO;
...
public class GetContractVoluntaryCancelNegotiationByRegisterAttendanceV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetContractVoluntaryCancelNegotiationByRegisterAttendance/V1/oauth2/token:::::::::::::::::*/
				ConnectJSONMicroServicesAPIs http = new ConnectJSONMicroServicesAPIs();
				System.out.println("\nTesting 2 - Send Http POST request");
				SecurityOauth2VO oauth2vo = new SecurityOauth2VO();
				oauth2vo.setAPI_NAME("/GetContractVoluntaryCancelNegotiationByRegisterAttendance/V1/oauth2/token");
				...
				/**:::::::::::::::::GetContractVoluntaryCancelNegotiationByRegisterAttendance/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO getContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO = new GetContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO();
				getContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO.setAPI_NAME("/GetContractVoluntaryCancelNegotiationByRegisterAttendance/V1");
				getContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO.setAccess_token(access_token);
				getContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO.setClientId("URAVOICE");
				getContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO.setProtocolNumber("59104273000129");
				getContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO.setRegisterAttendanceNumber("59104273000129");
				
				getContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO = (GetContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO) http.sendPost(getContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getContractVoluntaryCancelNegotiationByRegisterAttendanceV1VO.getResponseJsonByStringReader());
