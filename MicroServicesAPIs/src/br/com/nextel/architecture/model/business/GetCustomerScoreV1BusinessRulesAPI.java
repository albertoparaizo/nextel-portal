...
import br.com.nextel.architecture.model.valueobject.GetCustomerScoreV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetCustomerScoreV1BusinessRulesAPI {
	...
	public static String callService() {
		...
		String score = "Empty";
			for (int i = 0; i < 1; i++){
				...
				GetCustomerScoreV1VO customerScoreV1VO = new GetCustomerScoreV1VO();
				customerScoreV1VO.setAPI_NAME("/GetCustomerScore/V1");
				customerScoreV1VO.setAccess_token(access_token);
				customerScoreV1VO.setClientId("URAVOICE");
				customerScoreV1VO.setDocumentNumber("59104273000129");
				customerScoreV1VO = (GetCustomerScoreV1VO) http.sendPost(customerScoreV1VO, END_POINT_API);
...
//				customerScoreV1VO.setResponseJsonByStringReader(new StringReader(s));
				...
				JsonReader jsonReader = new JsonReader(customerScoreV1VO.getResponseJsonByStringReader());
				...
				if (jsonObjDataResponse != null) {
					if (jsonObjDataResponse.get("creditScore") != null)
						score = jsonObjDataResponse.get("creditScore").getAsString();
