...
import br.com.nextel.architecture.model.valueobject.GetCodeLocalityCityByAcronymsStateV1VO;
...
public class GetCodeLocalityCityByAcronymsStateV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetCodeLocalityCityByAcronymsState/V1/oauth2/token:::::::::::::::::*/
				ConnectJSONMicroServicesAPIs http = new ConnectJSONMicroServicesAPIs();
				System.out.println("\nTesting 2 - Send Http POST request");
				SecurityOauth2VO oauth2vo = new SecurityOauth2VO();
				oauth2vo.setAPI_NAME("/GetCodeLocalityCityByAcronymsState/V1/oauth2/token");
				...
				/**:::::::::::::::::GetCodeLocalityCityByAcronymsState/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetCodeLocalityCityByAcronymsStateV1VO getCodeLocalityCityByAcronymsStateV1VO = new GetCodeLocalityCityByAcronymsStateV1VO();
				getCodeLocalityCityByAcronymsStateV1VO.setAPI_NAME("/GetCodeLocalityCityByAcronymsState/V1");
				getCodeLocalityCityByAcronymsStateV1VO.setAccess_token(access_token);
				getCodeLocalityCityByAcronymsStateV1VO.setClientId("URAVOICE");
				getCodeLocalityCityByAcronymsStateV1VO.setStateCode("");
				getCodeLocalityCityByAcronymsStateV1VO = (GetCodeLocalityCityByAcronymsStateV1VO) http.sendPost(getCodeLocalityCityByAcronymsStateV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getCodeLocalityCityByAcronymsStateV1VO.getResponseJsonByStringReader());
