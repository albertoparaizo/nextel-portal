...
import br.com.nextel.architecture.model.valueobject.GetCustomerCostCenterListV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetCustomerCostCenterListV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetCustomerCostCenterList/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetCustomerCostCenterListV1VO getCustomerCostCenterListV1VO = new GetCustomerCostCenterListV1VO();
				getCustomerCostCenterListV1VO.setAPI_NAME("/GetCustomerCostCenterList/V1");
				getCustomerCostCenterListV1VO.setAccess_token(access_token);
				getCustomerCostCenterListV1VO.setClientId("URAVOICE");
				getCustomerCostCenterListV1VO.setDocumentNumber("59104273000129");
				getCustomerCostCenterListV1VO = (GetCustomerCostCenterListV1VO) http.sendPost(getCustomerCostCenterListV1VO, END_POINT_API);
...
//						   "}"+
//						"}";
//				customerScoreV1VO.setResponseJsonByStringReader(new StringReader(s));
				/*/TESTE TRACKING */
				
				JsonReader jsonReader = new JsonReader(getCustomerCostCenterListV1VO.getResponseJsonByStringReader());
