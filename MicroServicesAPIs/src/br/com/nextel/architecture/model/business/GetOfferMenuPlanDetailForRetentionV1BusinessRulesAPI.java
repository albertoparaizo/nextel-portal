...
import br.com.nextel.architecture.model.valueobject.GetOfferMenuPlanDetailForRetentionV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetOfferMenuPlanDetailForRetentionV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetOfferMenuPlanDetailForRetention/V1/oauth2/token:::::::::::::::::*/
				...
				oauth2vo.setAPI_NAME("/GetOfferMenuPlanDetailForRetention/V1/oauth2/token");
				...
				/**:::::::::::::::::GetOfferMenuPlanDetailForRetention/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetOfferMenuPlanDetailForRetentionV1VO getOfferMenuPlanDetailForRetentionV1VO = new GetOfferMenuPlanDetailForRetentionV1VO();
				getOfferMenuPlanDetailForRetentionV1VO.setAPI_NAME("/GetOfferMenuPlanDetailForRetention/V1");
				getOfferMenuPlanDetailForRetentionV1VO.setAccess_token(access_token);
				getOfferMenuPlanDetailForRetentionV1VO.setClientId("URAVOICE");
				getOfferMenuPlanDetailForRetentionV1VO.setRatePlan("2279");
				getOfferMenuPlanDetailForRetentionV1VO.setPlanName("Plano Equipe 180/Pós/SMP");
				getOfferMenuPlanDetailForRetentionV1VO = (GetOfferMenuPlanDetailForRetentionV1VO) http.sendPost(getOfferMenuPlanDetailForRetentionV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getOfferMenuPlanDetailForRetentionV1VO.getResponseJsonByStringReader());
