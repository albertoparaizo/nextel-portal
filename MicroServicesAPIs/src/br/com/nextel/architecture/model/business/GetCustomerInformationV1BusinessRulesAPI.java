...
public class GetCustomerInformationV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetCustomerInformation/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetCustomerInformationV1VO getCustomerInformationV1VO = new GetCustomerInformationV1VO();
				getCustomerInformationV1VO.setAPI_NAME("/GetCustomerInformation/V1");
				getCustomerInformationV1VO.setAccess_token(access_token);
				getCustomerInformationV1VO.setClientId("URAVOICE");
				getCustomerInformationV1VO.setDocumentNumber("59104273000129");
				getCustomerInformationV1VO = (GetCustomerInformationV1VO) http.sendPost(getCustomerInformationV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getCustomerInformationV1VO.getResponseJsonByStringReader());
