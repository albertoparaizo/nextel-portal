...
import br.com.nextel.architecture.model.valueobject.GetCustomerContactListV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetCustomerContactListV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				GetCustomerContactListV1VO customerContactListV1VO = new GetCustomerContactListV1VO();
				customerContactListV1VO.setAPI_NAME("/GetCustomerContactList/V1");
				customerContactListV1VO.setAccess_token(access_token);
				customerContactListV1VO.setClientId("URAVOICE");
				customerContactListV1VO.setDocumentNumber("59104273000129");
				customerContactListV1VO = (GetCustomerContactListV1VO) http.sendPost(customerContactListV1VO, END_POINT_API);
...
//				customerScoreV1VO.setResponseJsonByStringReader(new StringReader(s));
				...
				JsonReader jsonReader = new JsonReader(customerContactListV1VO.getResponseJsonByStringReader());
