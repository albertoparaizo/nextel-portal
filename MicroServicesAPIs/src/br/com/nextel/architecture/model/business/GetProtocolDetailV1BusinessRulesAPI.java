...
import br.com.nextel.architecture.model.valueobject.GetProtocolDetailV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetProtocolDetailV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetProtocolDetail/V1/oauth2/token:::::::::::::::::*/
				...
				oauth2vo.setAPI_NAME("/GetProtocolDetail/V1/oauth2/token");
				...
				/**:::::::::::::::::GetProtocolDetail/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetProtocolDetailV1VO getProtocolDetailV1VO = new GetProtocolDetailV1VO();
				getProtocolDetailV1VO.setAPI_NAME("/GetProtocolDetail/V1");
				getProtocolDetailV1VO.setAccess_token(access_token);
				getProtocolDetailV1VO.setClientId("URAVOICE");
				getProtocolDetailV1VO.setNumber("201700000227925");
				getProtocolDetailV1VO = (GetProtocolDetailV1VO) http.sendPost(getProtocolDetailV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getProtocolDetailV1VO.getResponseJsonByStringReader());
