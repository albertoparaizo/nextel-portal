...
public class GetAddressByZipCodeV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetAddressByZipCode/V1/oauth2/token:::::::::::::::::*/
				...
				oauth2vo.setAPI_NAME("/GetAddressByZipCode/V1/oauth2/token");
				...
				/**:::::::::::::::::GetAddressByZipCode/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetAddressByZipCodeV1VO getAddressByZipCodeV1VO = new GetAddressByZipCodeV1VO();
				getAddressByZipCodeV1VO.setAPI_NAME("/GetAddressByZipCode/V1");
				getAddressByZipCodeV1VO.setAccess_token(access_token);
				getAddressByZipCodeV1VO.setClientId("URAVOICE");
				getAddressByZipCodeV1VO.setZip("09616080");
				getAddressByZipCodeV1VO = (GetAddressByZipCodeV1VO) http.sendPost(getAddressByZipCodeV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getAddressByZipCodeV1VO.getResponseJsonByStringReader());
