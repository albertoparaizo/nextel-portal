...
import br.com.nextel.architecture.model.valueobject.GetRegisterAttendanceHistoryListV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetRegisterAttendanceHistoryListV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetRegisterAttendanceHistoryList/V1/oauth2/token:::::::::::::::::*/
				...
				oauth2vo.setAPI_NAME("/GetRegisterAttendanceHistoryList/V1/oauth2/token");
				...
				/**:::::::::::::::::GetRegisterAttendanceHistoryList/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetRegisterAttendanceHistoryListV1VO getRegisterAttendanceHistoryListV1VO = new GetRegisterAttendanceHistoryListV1VO();
				getRegisterAttendanceHistoryListV1VO.setAPI_NAME("/GetRegisterAttendanceHistoryList/V1");
				getRegisterAttendanceHistoryListV1VO.setAccess_token(access_token);
				getRegisterAttendanceHistoryListV1VO.setClientId("URAVOICE");
				getRegisterAttendanceHistoryListV1VO.setDocumentNumber("59104273000129");
				getRegisterAttendanceHistoryListV1VO.setStartDate("01/03/2017 00:00:00");
				getRegisterAttendanceHistoryListV1VO.setEndDate("01/06/2017 00:00:00");
				getRegisterAttendanceHistoryListV1VO.setProtocolNumber("");
				
				getRegisterAttendanceHistoryListV1VO = (GetRegisterAttendanceHistoryListV1VO) http.sendPost(getRegisterAttendanceHistoryListV1VO, END_POINT_API);
				
				JsonReader jsonReader = new JsonReader(getRegisterAttendanceHistoryListV1VO.getResponseJsonByStringReader());
