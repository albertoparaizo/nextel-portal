...
import br.com.nextel.architecture.model.valueobject.GetProtocolListByDocumentV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetProtocolListByDocumentV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetProtocolListByDocument/V1/oauth2/token:::::::::::::::::*/
				...
				oauth2vo.setAPI_NAME("/GetProtocolListByDocument/V1/oauth2/token");
				...
				/**:::::::::::::::::GetProtocolListByDocument/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetProtocolListByDocumentV1VO getProtocolListByDocumentV1VO = new GetProtocolListByDocumentV1VO();
				getProtocolListByDocumentV1VO.setAPI_NAME("/GetProtocolListByDocument/V1");
				getProtocolListByDocumentV1VO.setAccess_token(access_token);
				getProtocolListByDocumentV1VO.setClientId("URAVOICE");
				getProtocolListByDocumentV1VO.setDocumentNumber("59104273000129");
				getProtocolListByDocumentV1VO.setStartDate("01/03/2017 00:00:00");
				getProtocolListByDocumentV1VO.setEndDate("01/06/2017 00:00:00");
				
				getProtocolListByDocumentV1VO = (GetProtocolListByDocumentV1VO) http.sendPost(getProtocolListByDocumentV1VO, END_POINT_API);
				
				JsonReader jsonReader = new JsonReader(getProtocolListByDocumentV1VO.getResponseJsonByStringReader());
