...
import br.com.nextel.architecture.model.valueobject.GetDeviceQuantityV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetDeviceQuantityV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetDeviceQuantity/V1/oauth2/token:::::::::::::::::*/
				...
				oauth2vo.setAPI_NAME("/GetDeviceQuantity/V1/oauth2/token");
				...
				/**:::::::::::::::::GetDeviceQuantity/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetDeviceQuantityV1VO getDeviceQuantityV1VO = new GetDeviceQuantityV1VO();
				getDeviceQuantityV1VO.setAPI_NAME("/GetDeviceQuantity/V1");
				getDeviceQuantityV1VO.setAccess_token(access_token);
				getDeviceQuantityV1VO.setClientId("URAVOICE");
				getDeviceQuantityV1VO.setDocumentNumber("59104273000129");
				getDeviceQuantityV1VO = (GetDeviceQuantityV1VO) http.sendPost(getDeviceQuantityV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getDeviceQuantityV1VO.getResponseJsonByStringReader());
