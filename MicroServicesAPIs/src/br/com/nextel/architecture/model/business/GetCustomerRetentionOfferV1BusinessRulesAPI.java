...
import br.com.nextel.architecture.model.valueobject.GetCustomerRetentionOfferV1VO;
import br.com.nextel.architecture.model.valueobject.SecurityOauth2VO;

public class GetCustomerRetentionOfferV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetCustomerRetentionOffer/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetCustomerRetentionOfferV1VO getCustomerRetentionOfferV1VO = new GetCustomerRetentionOfferV1VO();
				getCustomerRetentionOfferV1VO.setAPI_NAME("/GetCustomerRetentionOffer/V1");
				getCustomerRetentionOfferV1VO.setAccess_token(access_token);
				getCustomerRetentionOfferV1VO.setClientId("URAVOICE");
				getCustomerRetentionOfferV1VO.setContractId("13468");
				getCustomerRetentionOfferV1VO = (GetCustomerRetentionOfferV1VO) http.sendPost(getCustomerRetentionOfferV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getCustomerRetentionOfferV1VO.getResponseJsonByStringReader());
