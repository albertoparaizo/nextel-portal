...
import br.com.nextel.architecture.model.valueobject.GetCustomerContractInformationV1VO;
...
public class GetCustomerContractInformationV1BusinessRulesAPI {
	...
	public static void main(String[] args) throws Exception {
		...
		long timeResult = 0;
			...
			for (int i = 0; i < 1; i++){
				...
				/**:::::::::::::::::GetCustomerContractInformation/V1:::::::::::::::::*/
				http = new ConnectJSONMicroServicesAPIs();
				GetCustomerContractInformationV1VO getCustomerContractInformationV1VO = new GetCustomerContractInformationV1VO();
				getCustomerContractInformationV1VO.setAPI_NAME("/GetCustomerContractInformation/V1");
				getCustomerContractInformationV1VO.setAccess_token(access_token);
				getCustomerContractInformationV1VO.setClientId("URAVOICE");
				getCustomerContractInformationV1VO.setDocumentNumber("59104273000129");
				getCustomerContractInformationV1VO = (GetCustomerContractInformationV1VO) http.sendPost(getCustomerContractInformationV1VO, END_POINT_API);
				
				
				JsonReader jsonReader = new JsonReader(getCustomerContractInformationV1VO.getResponseJsonByStringReader());
