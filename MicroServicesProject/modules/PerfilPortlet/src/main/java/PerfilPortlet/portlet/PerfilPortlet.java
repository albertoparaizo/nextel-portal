package PerfilPortlet.portlet;

import PerfilPortlet.constants.PerfilPortletKeys;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=PerfilPortlet Portlet",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + PerfilPortletKeys.Perfil,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class PerfilPortlet extends MVCPortlet {
